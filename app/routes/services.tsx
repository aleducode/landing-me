...
export default function Services() {
  return (
    <div className="min-h-screen bg-green">
      <Layout>
        {/* Intro Section */}
        <section className="bg-green-400/3 border-b border-white/10 px-6 md:px-12 pt-14 pb-12 relative">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6 md:gap-12">
            ...
            <div className="flex items-center gap-0 pr-4 md:pr-7">
              <div className="bg-green-400 border border-green-400/10 rounded-full p-6 md:p-8 w-20 h-20 md:w-28 md:h-28 flex items-center justify-center relative z-[3] -mr-5 md:-mr-7 backdrop-blur-[50px]">
                <div className="size-10 md:size-14 flex items-center justify-center text-2xl md:text-4xl">💻</div>
              </div>
              <div className="bg-green-400/35 border border-green-400/10 rounded-full p-6 md:p-8 w-20 h-20 md:w-28 md:h-28 flex items-center justify-center relative z-[2] -mr-5 md:-mr-7 backdrop-blur-[50px]">
                <div className="size-10 md:size-14 flex items-center justify-center text-2xl md:text-4xl">⚙️</div>
              </div>
              <div className="bg-green-400/10 border border-green-400/10 rounded-full p-6 md:p-8 w-20 h-20 md:w-28 md:h-28 flex items-center justify-center relative z-[1] backdrop-blur-[50px]">
                <div className="size-10 md:size-14 flex items-center justify-center text-2xl md:text-4xl">🏌️</div>
              </div>
            </div>
          </div>
        ...
        <section className="px-6 md:px-12 py-8 md:py-10 border-b border-white/10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {/* Web Development */}
            <div className="bg-green-400/5 border border-green-400/5 rounded-xl p-5 md:p-6 relative overflow-hidden">
              <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-48 md:w-60 h-16 bg-green-400/20 rounded-full blur-[50px]"></div>
              <div className="bg-green-400/5 border border-green-400/5 rounded-xl p-4 md:p-5 w-12 h-12 md:w-14 md:h-14 flex items-center justify-center mb-6 md:mb-8">
                <svg width="24" height="24" viewBox="0 0 28 28" fill="none" className="text-green-400 w-6 h-6 md:w-7 md:h-7">
            ...
            {[
              {
                name: "HTML",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 57 56" fill="none" className="w-10 h-10 md:w-14 md:h-14">
              ...
              },
              {
                ...
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 57 56" fill="none" className="w-10 h-10 md:w-14 md:h-14">
                    ...
                    <path fillRule="evenodd" clipRule="evenodd" d="M43.2203 49.898L46.5 13.0227H10.5L13.7762 49.9038L28.478 54L43.2203 49.898ZM39.774 20.5616H17.1989L17.6086 25.085H34.8349L34.4248 29.7169L18.0108 29.7169L18.4148 34.2402L34.034 34.2402L33.5108 40.1066L28.4843 41.4686L28.4801 41.4697L23.4608 40.1095L23.1399 36.5019H18.6158L19.2472 43.6041L28.4791 46.1764L28.4998 46.1706V46.1699L37.7236 43.6042L38.8504 30.9316L38.9604 29.7169L39.774 20.5616Z" fill="#2EF171"/>
                  </svg>
                )
              },
              {
              ...
              },
              {
                name: "Database",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="28" viewBox="0 0 52 36" fill="none" className="w-10 h-8 md:w-14 md:h-10">
              ...
              <div key={tech.name} className="bg-green-400/5 border border-green-400/5 rounded-xl p-8 md:p-12 flex items-center justify-center">
